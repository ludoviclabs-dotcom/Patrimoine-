...
export const simulationCatalog: SimulationCatalogItem[] = [
  ...
  },
  {
    ...
    label: "Transmission / donation",
    category: "Simuler",
    status: "Revue requise",
    certainty: "regle sourcee",
    sourceIds: ["src-impots-dmtg-bareme-2026", "src-legifrance-code-civil-transmission"],
    reviewRequired: true,
    userFacingExplanation:
      "Chiffre les droits de donation selon le lien de parenté, les abattements et le rappel fiscal de 15 ans.",
    scenarioParam: "transmission",
    aliases: ["donation", "dmtg"],
    href: "/simulations?scenario=transmission",
    activeLabel: "Barème DMTG multi-liens",
    dataUsed: "Valeur transmise, lien de parenté, âge du donateur, donations antérieures.",
    hypothesis: "Donation simple ou en nue-propriété ; donation-partage et soultes non modélisées.",
    rule: "Barème DMTG art. 777 et abattements art. 779/790 (règle versionnée).",
    limit: "La liquidation définitive des droits relève du notaire (rappel fiscal, représentations).",
    reviewGate: "Revue notaire avant toute décision de donation.",
  },
  {
  ...
  },
  {
    ...
    status: "Simulation indicative",
    certainty: "regle sourcee",
    sourceIds: ["src-service-public-is-taux-2026"],
    reviewRequired: true,
    userFacingExplanation:
      "Calcule l'IS 2026 : taux réduit 15 % PME, taux normal 25 % et contribution sociale.",
    scenarioParam: "is",
    aliases: ["impot-societes"],
    href: "/simulations?scenario=is",
    activeLabel: "Nouveau moteur V3",
    dataUsed: "Bénéfice fiscal, chiffre d'affaires, composition du capital.",
    hypothesis: "Résultat fiscal déclaré par le conseiller, hors réintégrations et déficits.",
    rule: "Art. 219 CGI : 15 % ≤ 42 500 € (CA ≤ 10 M€, ≥ 75 % personnes physiques), 25 % au-delà.",
    limit: "Réintégrations, déficits reportables et intégration fiscale non automatisés.",
    reviewGate: "Revue expert-comptable.",
  },
  {
    id: "simulation-sci-arbitrage",
    label: "SCI IR vs IS",
    category: "Simuler",
    status: "Revue requise",
    certainty: "simulation indicative",
    sourceIds: ["src-bofip-sci-is-2026", "src-service-public-is-taux-2026"],
    reviewRequired: true,
    userFacingExplanation:
      "Compare l'imposition annuelle et la fiscalité de sortie d'une SCI à l'IR et à l'IS.",
    scenarioParam: "sci-arbitrage",
    aliases: ["sci", "sci-ir-is"],
    href: "/simulations?scenario=sci-arbitrage",
    activeLabel: "Nouveau moteur V3",
    dataUsed: "Loyers, charges, intérêts, base amortissable, TMI, projection de cession.",
    hypothesis: "Amortissement linéaire simplifié ; distribution des résultats non modélisée.",
    rule: "Revenus fonciers (TMI + PS 17,2 %) vs IS après amortissements, PV professionnelle à la sortie.",
    limit: "La réintégration des amortissements à la cession impose un chiffrage expert-comptable.",
    reviewGate: "Revue expert-comptable obligatoire.",
  },
  {
    id: "simulation-exit-tax",
    label: "Exit tax",
    category: "Simuler",
    status: "Revue requise",
    certainty: "simulation indicative",
    sourceIds: ["src-legifrance-cgi-167-bis-2026"],
    reviewRequired: true,
    userFacingExplanation:
      "Détecte le champ d'application de l'exit tax (art. 167 bis) avant un départ de France.",
    scenarioParam: "exit-tax",
    aliases: ["expatriation", "167-bis"],
    href: "/simulations?scenario=exit-tax",
    activeLabel: "Signal documentaire",
    dataUsed: "Plus-values latentes, participation, valeur des titres, destination.",
    hypothesis: "Résidence fiscale française ≥ 6 des 10 dernières années déclarée.",
    rule: "Seuils 800 000 € de PV latentes ou 50 % de participation ; sursis UE/EEE automatique.",
    limit: "Aucune liquidation : conventions fiscales et participations indirectes à qualifier.",
    reviewGate: "Dossier avocat fiscaliste obligatoire avant le départ.",
  },
  {
