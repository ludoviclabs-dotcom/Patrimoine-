...
export const simulationCatalog: SimulationCatalogItem[] = [
  ...
  {
    id: "simulation-assurance-vie",
    label: "Assurance-vie décès",
    category: "Simuler",
    status: "Revue requise",
    certainty: "simulation indicative",
    sourceIds: ["src-bofip-tcas-aut-60-2026", "src-impots-dmtg-bareme-2026"],
    reviewRequired: true,
    userFacingExplanation:
      "Chiffre 990 I (152 500 €, 20/31,25 %) et 757 B (30 500 €) selon l'âge des versements.",
    scenarioParam: "assurance-vie",
    aliases: ["av-transmission", "990i"],
    href: "/simulations?scenario=assurance-vie",
    activeLabel: "Nouveau moteur V3",
    dataUsed: "Capitaux décès avant/après 70 ans, bénéficiaires, lien de parenté.",
    hypothesis: "Ventilation par contrat déclarée par le conseiller, clauses standards.",
    rule: "Art. 990 I et 757 B CGI (règle versionnée, source BOFiP à re-vérifier).",
    limit: "Clauses démembrées, vie-génération et intégration successorale fine non automatisées.",
    reviewGate: "Revue notaire obligatoire avant toute restitution.",
  },
  {
