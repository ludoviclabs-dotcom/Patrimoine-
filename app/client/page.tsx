...
import { AggregationPanel } from "@/components/v3-3/aggregation-panel";
import { ClientPortalGate } from "@/components/v3-3/client-portal-gate";
import { getSimulatedAccounts } from "@/lib/aggregation/simulated-accounts";
      ...
      <div className="space-y-6">
        <section>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-muted">
            Espace restreint au rôle client : synthèse, comptes agrégés, pièces demandées et rappels
            des droits — jamais les brouillons ni les hypothèses de travail du cabinet.
          </p>
        </section>
        <ClientPortalGate>
          <CompletenessScorePanel />
          <AggregationPanel accounts={accounts} />
          <DocumentChecklist />
          <Card>
            <CardHeader>
              <div>
